...
.banner {
        ...
        .globe {
          /* Slightly smaller globe for mobile */
          width: 100px;
          height: 100px; 
        ...
        .divider {
          /* Change to a vertical divider for mobile */
          width: 1px; 
          height: 2px;
          background: #888;
          border-radius: 4px;
        ...
        .rich-line {
          font-size: 10rem; /* Slightly smaller font for mobile */
        }
        ...
        @media (min-width: 768px) {
          ...
          .globe {
            /* Restore original globe size */
            width: 150px;
            height: 150px;
          }

          .divider {
            /* Switch back to a vertical divider */
            width: 3px;
            height: 80px; 
            border-radius: 4px;
          }
        ...
        .rich-line {
	     ...
	     .social-sidebar {
            position: fixed; /* This is the key property that makes it "stick" */
            top: 50%; /* Positions it vertically in the middle of the screen */
            left: 50px; /* Positions it from the left edge of the screen */
            transform: translateY(-50%); /* This perfectly centers it vertically */
            z-index: 1000; /* Ensures it stays on top of other page content */
            
            display: flex;
            flex-direction: column; /* Stacks the icons on top of each other */
            gap: 1px; /* Adds space between the icons */
            
            background-color: #0e0101e6;
            padding: 15px 10px;
            border-radius: 8px;
            box-shadow: 0 4px 8px rgba(232, 226, 226, 0.828);
            margin-top: 110px;
        }

        /* Styling for the individual icon links */
        .social-sidebar a {
            color: #fff5f5; /* Icon color */
            font-size: 24px; /* Icon size */
            transition: transform 0.2s ease-in-out, color 0.2s;
        }

        /* Adds a nice effect when you hover over the icons */
...
<!-- <div class="text-center pics_in_a_row">
  ...
  <a href="https://www.richinc.org/RICH/rich_new_vision/rich_new_vision.html">
    ...
    <div class="banner">
          <img src="brand-globe.png" alt="RICH Globe" class="globe">
          <div class="divider"></div>
          <div class="text">
            <img src="images/rich-logo.svg" class="svg-image" alt="RICH">
          </div>
        </div>


    <div class="social-sidebar">
                <a href="https://www.instagram.com/richincstudents/" target="_blank"><i class="fab fa-instagram"></i></a>
                <a href="https://www.linkedin.com/company/reach-into-cultural-heights/" target="_blank"><i class="fab fa-linkedin"></i></a>
                <a href="https://www.youtube.com/channel/UCqAvWoYXzpvOtIstzJ8LBBg?view_as=subscriber" target="_blank"><i class="fab fa-youtube"></i></a>
                <a href="https://www.tiktok.com/@reachintoculturalheights" target="_blank"><i class="fab fa-tiktok"></i></a>
              </div>
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      ...
                      <li class="has-children">
                        ...
                        <ul class="dropdown menu1">
                          ...
                          <li><a href="interns.html">College Interns</a></li>
